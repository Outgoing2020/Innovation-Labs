            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={{ alignSelf: "center" }}>
                    <View style={styles.profileImage}>
                        <Image source={require("../assets/pp.jpg")} style={styles.image} resizeMode="center"></Image>
                    </View>
                ...
                <View style={{ alignItems: "center" }}>
                    <View style={styles.recentItem}>
                        ...
                        <View style={{ width: 250 }}>
                            <Text style={[styles.text, { color: "#41444B", fontWeight: "300" }]}>
                                Joined <Text style={{ fontWeight: "400" }}>OUTGOING</Text> and <Text style={{ fontWeight: "400" }}>ILabs</Text>
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.recentItem}>
                        ...
                        <View style={{ width: 250 }}>
                            <Text style={[styles.text, { color: "#41444B", fontWeight: "300" }]}>
                                Started following <Text style={{ fontWeight: "400" }}>OUTGOING</Text>
                            </Text>
                        </View>
                    </View>
                </View>
